...
function StartUp()
{
  ...
  document.getElementById("calEmbed").style.display = "none";
}
...
function calendar()
{
    document.getElementById("calEmbed").style.display = "inline-block";
    document.getElementById("timer").style.display = "none";
    document.getElementById("timerNav").classname = "inactive";
    document.getElementById("calendarNav").classname = "active";
}
...
function timer()
{
    ...
    document.getElementById("timerNav").classname = "active";
    document.getElementById("calendarNav").classname = "inactive";
}